                  ...
                  {pages.map((page) => {
                    if (page === 'About Us') {
                      return (
                        <DropdownMenu key={page}>
                          <DropdownMenuTrigger asChild>
                            <Button variant="ghost" className="flex items-center font-semibold text-lg text-[var(--grey)] w-full justify-start">
                              {page}
                              <svg width="20" height="20" fill="none" className="ml-1"><path d="M6 8l4 4 4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            </Button>
                          </DropdownMenuTrigger>
                          <DropdownMenuContent side="right">
                            {aboutItems.map((item) => (
                              <DropdownMenuItem key={item} asChild>
                                <Link href="/" passHref>
                                  <span className="text-[var(--grey)] cursor-pointer">{item}</span>
                                </Link>
                              </DropdownMenuItem>
                            ))}
                          </DropdownMenuContent>
                      ...
                      return (
                        <Link key={page} href='/' passHref>
                          <Button variant="ghost" className="font-semibold text-lg text-[var(--grey)] w-full justify-start">
                            {page}
                          </Button>
                        </Link>
                      );
